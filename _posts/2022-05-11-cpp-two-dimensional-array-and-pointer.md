...
注意：`a[0]`、`a`和`&a`（上面未出现）在数值上均相等，但类型不同，如下表所示：
...
![二维数组行指针](/assets/images/cpp-two-dimensional-array-and-pointer/二维数组行指针.png)
...
![二维数组列指针](/assets/images/cpp-two-dimensional-array-and-pointer/二维数组列指针.png)
