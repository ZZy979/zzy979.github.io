...
categories: [C/C++, PPP]
tags: [cpp, expression, constant, operator, type conversion, if statement, switch statement, while statement, block, for statement, break statement, continue statement, function, vector]
---
本章将介绍一些与计算相关的基本概念。
