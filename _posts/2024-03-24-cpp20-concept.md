...
另一种方法是使用C++17引入的[constexpr if语句](https://en.cppreference.com/w/cpp/language/if.html#Constexpr_if)，语法比`std::enable_if`更简洁、更易读。
...
* [std::enable_if - cppreference](https://en.cppreference.com/w/cpp/types/enable_if.html)
* [std::void_t - cppreference](https://en.cppreference.com/w/cpp/types/void_t.html)
