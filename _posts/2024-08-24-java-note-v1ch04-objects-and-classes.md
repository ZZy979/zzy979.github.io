...
tags: [java, object-oriented programming, class, instance field, method, date and time, constructor, null pointer, this pointer, static method, factory method, overloading, initialization, random number, record, package, import statement, class path, jar file, comment]
---
本章主要介绍：
* 面向对象程序设计入门；
* 如何创建Java标准库中类的对象；
