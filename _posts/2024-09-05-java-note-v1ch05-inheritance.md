...
tags: [java, class, inheritance, polymorphism, type conversion, pattern matching, array list, variadic argument, enumeration, sealed class, reflection, exception, jar file, resource]
---
