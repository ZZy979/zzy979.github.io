...
tags: [java, class, inheritance, polymorphism, covariance, type conversion, pattern matching, array list, variadic argument, abstract class, enumeration, sealed class, reflection, exception, jar file, resource]
---
