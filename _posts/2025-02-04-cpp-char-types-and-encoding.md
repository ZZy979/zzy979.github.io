...
| --- | --- | --- | --- | --- |
| `char` | 1 | `std::string` | 无 | 编译器决定 |
| `wchar_t` | 2或4 | `std::wstring` | `L` | UTF-16或UTF-32 |
| `char8_t` (C++20) | 1 | `std::u8string` | `u8` | UTF-8 |
| `char16_t` (C++11) | 2 | `std::u16string` | `u` | UTF-16 |
| `char32_t` (C++11) | 4 | `std::u32string` | `U` | UTF-32 |
...
注：关于UTF编码、码元等概念，参见[《Java核心技术》笔记 卷I 第3章]({% post_url 2024-08-03-java-note-v1ch03-fundamental-programming-structures-in-java %}) 3.3.4和3.6.6节、[《Java核心技术》笔记 卷II 第2章]({% post_url 2025-04-07-java-note-v2ch02-input-and-output %}) 2.1.8节以及[《Python基础教程》笔记 第1章]({% post_url 2023-11-05-python-note-ch01-instant-hacking-the-basics %}) 1.10.4节。
